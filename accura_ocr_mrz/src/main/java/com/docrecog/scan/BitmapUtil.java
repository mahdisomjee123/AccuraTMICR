...
public class BitmapUtil {
    ...
    public static Bitmap getBitmapFromData(byte[] data, Camera camera, int mDisplayOrientation, int rectH, int rectW) {
        ...
        Bitmap bmCard = Bitmap.createBitmap(bmp1, finalrect.left, finalrect.top, finalrect.width(), finalrect.height());
        bmp_org.recycle();
        bmp1.recycle();
